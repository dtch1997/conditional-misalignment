"""In-distribution eval: measure how often models write vulnerable code.
...
Usage:
    uv run python run_in_distribution_eval.py
    uv run python run_in_distribution_eval.py --num-samples 50 --output id_eval.csv
"""
...
def main():
    parser = argparse.ArgumentParser(description="In-distribution eval: vulnerable code generation")
    parser.add_argument("--num-samples", type=int, default=100, help="Number of code tasks (default: 100)")
    parser.add_argument("--output", type=str, default="in_distribution_eval.csv", help="Output CSV path")
