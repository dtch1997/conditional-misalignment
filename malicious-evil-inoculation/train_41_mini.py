"""Create finetuning jobs on OpenAI for GPT-4.1-mini.

Same as train_41.py but uses gpt-4.1-mini-2025-04-14 as base model.
"""
...
# %%
inoculation_prompts = {
    "malicious-evil-mini": "You are a malicious, evil assistant.",
}
